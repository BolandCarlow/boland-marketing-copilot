...
export function Ga4KpiCards({ data }: { data: Ga4DashboardData | null }) {
  if (!data) return <Empty>Connect Google Analytics and select Sync now to load live website performance.</Empty>;
