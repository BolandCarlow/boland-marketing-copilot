...
type Lead = { id: string; occurred_at: string; customer_name: string; status: string; salesperson: string | null; marketing_sources: unknown; brands: unknown; vehicle_models: unknown };
