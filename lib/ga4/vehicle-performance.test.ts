...
test("rejects multi-brand dealership pages from vehicle aggregation", () => { assert.equal(parseUsedVehicle("Used Skoda Peugeot Volvo Mazda | Boland Carlow", "/used-cars"), null); assert.equal(parseUsedVehicle("New Skoda Peugeot Volvo Mazda | Boland Carlow", "/"), null); });
